...
const UIUXDesignFT = () => { 
    ...
    const handleFetch = () =>{
        ...
        const apiURL = experience ? `https://7s81h0b9-4000.asse.devtunnels.ms/job/filter?jobType=1&position=2&experience=${experience}` :
                                    `https://7s81h0b9-4000.asse.devtunnels.ms/job/filter?jobType=1&position=2`;
