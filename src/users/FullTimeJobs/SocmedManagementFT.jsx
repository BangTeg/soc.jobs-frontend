...
const SocmedManagementFT = () => { 
    ...
    const handleFetch = () =>{
        ...
        const apiURL = experience ? `https://50cglb1j-4000.asse.devtunnels.ms/job/filter?jobType=1&position=1&experience=${experience}` :
                                    `https://50cglb1j-4000.asse.devtunnels.ms/job/filter?jobType=1&position=1`;
