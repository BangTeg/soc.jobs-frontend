...
const SocmedManagementINT = () => { 
    ...
    const handleFetch = () =>{
        ...
        const apiURL = experience ? `https://50cglb1j-4000.asse.devtunnels.ms/job/filter?jobType=3&position=1&experience=${experience}` :
                                    `https://50cglb1j-4000.asse.devtunnels.ms/job/filter?jobType=3&position=1`;
...
export default SocmedManagementINT;