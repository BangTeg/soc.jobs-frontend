...
const UIUXDesignFL = () => { 
    ...
    const handleFetch = () =>{
        ...
        const apiURL = experience ? `https://7s81h0b9-4000.asse.devtunnels.ms/job/filter?jobType=2&position=2&experience=${experience}` :
                                    `https://7s81h0b9-4000.asse.devtunnels.ms/job/filter?jobType=2&position=2`;
