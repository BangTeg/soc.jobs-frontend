...
const BrandingFL = () => { 
    ...
    const handleFetch = () =>{
        ...
        const apiURL = experience ? `https://50cglb1j-4000.asse.devtunnels.ms/job/filter?jobType=2&position=3&experience=${experience}` :
                                    `https://50cglb1j-4000.asse.devtunnels.ms/job/filter?jobType=2&position=3`;
